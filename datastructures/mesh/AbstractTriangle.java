...
//--------------------------------------------------------------------
    public abstract int getVertexIndices(int index);
//---------------------------------------------------------------------
     ...
     */
    public abstract void addVertexIndexOffset(int vertexOffset);

    /**
     * Create a new triangle object with the same state as this.
     */
    public abstract AbstractTriangle clone();

    /**
     * Set the three vertex indices.
     */
    public abstract void setVertexIndices(int vertexIndex1, int vertexIndex2, int vertexIndex3);
}
