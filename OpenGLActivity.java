...
import edu.hawhamburg.shared.datastructures.skeleton.SkeletonScene;
...
import edu.hawhamburg.shared.scenegraph.TriangleMeshNodeFactory;
...
public class OpenGLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scene = new SkeletonScene(new TriangleMeshFactory(), new TriangleMeshNodeFactory());
        ...
        TextureManager.getInstance().setup(PACKAGE_NAME, getApplicationContext());
